...
<!-- COOKIE TEST END -->
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active">
                                    <a href="mypage.do"><i class="fa fa-list"></i> 주문내역</a>
                                </li>
                                <li>
                                    <a href="wishlist.do"><i class="fa fa-heart"></i> 찜 목록</a>
                                </li>
                                <li>
                                    <a href="infomation.do"><i class="fa fa-user"></i> 내 정보보기</a>
                                </li>
                                <li>
                    ...
                    <div class="box">
                        ...
                        <div class="well">
	                        <div class="row" style="margin:0;">
	                        	2017/09/01
                        		<a href="#" style="float: right;">주문상세</a>
	                        </div>
	                        <hr style="margin:5px;">
	                        <div class="row" style="margin:0; ">
                     			<a href="customer-order.jsp" >
                     				<img src="resources/img/sample.gif" style="margin: 10px; width:60px; height:60px; float: left;"/>
                   				</a>
                        ...
                        <div class="well" style="min-width: 250px;">
                        	...
                        	<div class="row" style="margin:0;">
                        		<strong>72,500원</strong>
                        		<span class="label label-warning" style="float: right;">On hold</span>
                        	</div>
                        </div>
                        ...
                        <div class="well" style="min-width: 250px;">
                        	...
                        	<div class="row" style="margin:0;">
                        		<strong>72,500원</strong>
                        		<span class="label label-success" style="float: right;">Received</span>
                        	</div>
                        </div>
                        ...
                        <div class="well" style="min-width: 250px;">
                        	...
                        	<div class="row" style="margin:0;">
                        		<strong>72,500원</strong>
                        		<span class="label label-danger" style="float: right;">Cancelled</span>
                        	</div>
                        </div>
				...
				<div class="col-md-1 visible-lg-block visible-md-block" style="position: fixed; margin-left: 480px; left: 50%; bottom: 365px;">
								...
								if (ck != null) {
									for (Cookie c : ck) {
										if (c.getName().indexOf("sname") != -1) {
											out.println(
													java.net.URLDecoder.decode("<a href='" + c.getValue() + ".do'>" + "<img src='resources/img/sample.gif' style='margin: 10px; width: 60px; height: 100px;' /><br>" + c.getValue(), "UTF-8")
															+ "</a><br/>");
										}
									}
								}

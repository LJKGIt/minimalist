...
CREATE TABLE ORDERINFO(
    ...
    CONSTRAINT  FK_ORDERINFO_AUCTION_CODE FOREIGN KEY (AUCTION_CODE) REFERENCES AUCTION (AUCTION_CODE)
);
...
COMMENT ON COLUMN ORDERINFO.AUCTION_CODE IS '경매 코드';

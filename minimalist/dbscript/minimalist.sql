...
CREATE TABLE AUCTION(
    ...
    PAYMENT_YN  CHAR(1) DEFAULT 'n' CONSTRAINT CHK_PAY CHECK (PAYMENT_YN IN('y', 'n')), /* 결제 여부 */
...
COMMENT ON COLUMN AUCTION.BID_PRICE IS '입찰 가격';
COMMENT ON COLUMN AUCTION.START_DATE IS '시작 날짜';
COMMENT ON COLUMN AUCTION.END_DATE IS '낙찰 날짜';
...
COMMENT ON COLUMN AUCTION.PAYMENT_YN IS '결제 여부';
...
COMMENT ON COLUMN REVIEW.REVIEW_RATING IS '별 갯수';

...
COMMENT ON COLUMN MEMBER.REGIST_DATE IS '';
COMMENT ON COLUMN MEMBER.PHONE IS '';
COMMENT ON COLUMN MEMBER.POST IS '';
COMMENT ON COLUMN MEMBER.ADDRESS1 IS '';
COMMENT ON COLUMN MEMBER.ADDRESS2 IS '';
COMMENT ON COLUMN MEMBER.POINT IS '';
COMMENT ON COLUMN MEMBER.GRADE IS '';
COMMENT ON COLUMN MEMBER.DORMANT_YN IS '';
...
CREATE TABLE PRODUCT(
    ...
    PRODUCT_DELETE CHAR(1) DEFAULT '0' CONSTRAINT CHK_PRODUCT_DELETE CHECK (PRODUCT_DELETE IN('0', '1'))
);

COMMENT ON COLUMN PRODUCT.PRODUCT_CODE IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_NAME IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_CATEGORY IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_BRAND IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_DESCRIPT IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_ORIGINAL_PRICE IS '';
COMMENT ON COLUMN PRODUCT.RENT_PRICE IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_SIZE33 IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_SIZE44 IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_SIZE55 IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_SIZE66 IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_SIZE77 IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_COLOR IS '';
COMMENT ON COLUMN PRODUCT.RECEIVE_DATE IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_HIT IS '';
COMMENT ON COLUMN PRODUCT.PRODUCT_DELETE IS '';
...
COMMENT ON COLUMN ORDERINFO.ORDERINFO_CODE IS '';
COMMENT ON COLUMN ORDERINFO.MEMBER_ID IS '';
COMMENT ON COLUMN ORDERINFO.PRODUCT_CODE IS '';
COMMENT ON COLUMN ORDERINFO.ORDERINFO_DATE IS '';
...
COMMENT ON COLUMN RENT_LIST.RENT_CODE IS '';
COMMENT ON COLUMN RENT_LIST.PRODUCT_CODE IS '';
COMMENT ON COLUMN RENT_LIST.MEMBER_ID IS '';
COMMENT ON COLUMN RENT_LIST.RENT_DATE IS '';
COMMENT ON COLUMN RENT_LIST.RETURN_DATE IS '';
...
COMMENT ON COLUMN RENTAL_RESERVE.PRODUCT_CODE IS '';
COMMENT ON COLUMN RENTAL_RESERVE.MEMBER_ID IS '';
COMMENT ON COLUMN RENTAL_RESERVE.RESERVE_DATE IS '';
COMMENT ON COLUMN RENTAL_RESERVE.RETURN_DATE IS '';
...
COMMENT ON COLUMN WISH.MEMBER_ID IS '';
COMMENT ON COLUMN WISH.PRODUCT_CODE IS '';
...
COMMENT ON COLUMN MESSAGE.MESSAGE_NUMBER IS '';
COMMENT ON COLUMN MESSAGE.MEMBER_ID IS '';
COMMENT ON COLUMN MESSAGE.MESSAGE_TITLE IS '';
COMMENT ON COLUMN MESSAGE.MESSAGE_CONTENT IS '';
COMMENT ON COLUMN MESSAGE.SEND_DATE IS '';
COMMENT ON COLUMN MESSAGE.CHECK_YN IS '';
...
COMMENT ON COLUMN AUCTION.AUCTION_CODE IS '';
COMMENT ON COLUMN AUCTION.PRODUCT_NAME IS '';
COMMENT ON COLUMN AUCTION.PRODUCT_CATEGORY IS '';
COMMENT ON COLUMN AUCTION.PRODUCT_BRAND IS '';
COMMENT ON COLUMN AUCTION.PRODUCT_DESCRIPT IS '';
COMMENT ON COLUMN AUCTION.MEMBER_ID IS '';
COMMENT ON COLUMN AUCTION.BID_PRICE IS '';
COMMENT ON COLUMN AUCTION.START_DATE IS '';
COMMENT ON COLUMN AUCTION.END_DATE IS '';
COMMENT ON COLUMN AUCTION.PRODUCT_SIZE IS '';
COMMENT ON COLUMN AUCTION.PRODUCT_COLOR IS '';
COMMENT ON COLUMN AUCTION.PRODUCT_COLOR IS '';
COMMENT ON COLUMN AUCTION.IMAGE_PATH IS '';
COMMENT ON COLUMN AUCTION.PAYMENT_YN IS '';
...
COMMENT ON COLUMN ALERT.MEMBER_ID IS '';
COMMENT ON COLUMN ALERT.PRODUCT_CODE IS '';
COMMENT ON COLUMN ALERT.ALERT_DATE IS '';
...
COMMENT ON COLUMN REVIEW.REVIEW_NO IS '';
COMMENT ON COLUMN REVIEW.PRODUCT_CODE IS '';
...
COMMENT ON COLUMN REVIEW.ORIGINAL_IMG_NAME IS '';
COMMENT ON COLUMN REVIEW.RENAME_IMG_NAME IS '';
...
COMMENT ON COLUMN QNA.QNA_NO IS '';
COMMENT ON COLUMN QNA.MEMBER_ID IS '';
COMMENT ON COLUMN QNA.QNA_TITLE IS '';
COMMENT ON COLUMN QNA.QNA_CONTENT IS '';
COMMENT ON COLUMN QNA.QNA_CATEGORY IS '';
COMMENT ON COLUMN QNA.QNA_COMMENT IS '';
COMMENT ON COLUMN QNA.QNA_DATE IS '';
COMMENT ON COLUMN QNA.IMG_PATH IS '';
...
COMMENT ON COLUMN PRODUCT_IMAGE.PRODUCT_CODE IS '';
COMMENT ON COLUMN PRODUCT_IMAGE.PRODUCT_IMAGE_PATH IS '';
...
COMMENT ON COLUMN INCOME.PRODUCT_CODE IS '';
COMMENT ON COLUMN INCOME.AUCTION_CODE IS '';
COMMENT ON COLUMN INCOME.INCOME IS '';
COMMENT ON COLUMN INCOME.INCOME_DATE IS '';
